...
const SCHEMA = {
  ...
  stock:    { key: 'id', cols: ['id', 'vehicle', 'part_name', 'part_no', 'source', 'category', 'brand', 'unit_price', 'cost_price', 'init_qty', 'notes'], num: ['unit_price', 'cost_price', 'init_qty'] },
...
CREATE TABLE IF NOT EXISTS stock (
  ...
  source TEXT DEFAULT 'DMS', category TEXT, brand TEXT, unit_price NUMERIC DEFAULT 0, cost_price NUMERIC DEFAULT 0,
...
ALTER TABLE stock ADD COLUMN IF NOT EXISTS brand TEXT;
